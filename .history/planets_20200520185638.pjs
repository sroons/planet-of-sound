...
function three_body(p1, p2) {
    return [
        {mass: 100, x: -100, y: 0, velX: 100 * p1, velY: 100 * p2, color: "#ccc", soundWave:"sine2"},
        {mass: 100, x: 100, y: 0, velX: 100 * p1, velY: 100 * p2, color: "#cc0", soundWave:"sine4"},
        {mass: 100, x: 0, y: 0, velX: -200 * p1, velY: -200 * p2, color: "#c00", soundWave:"sine6"},
    ];
}
...
var systems = {
    ...
    test: [
			{mass: 200, x: 0, y: 0, velX: 0, velY: 0, color: "#ccc", soundWave:"sine2"},
			{mass: 10, x: 160, y: 0, velX: 0, velY: 120, color: "#cc0", soundWave:"sine4"},

		],
		sun_planet_moon: [
        {mass: 200, x: 0, y: 0, velX: 0, velY: 0, color: "#ccc", soundWave:"sine2"},
        {mass: 10, x: 160, y: 0, velX: 0, velY: 120, color: "#cc0", soundWave:"sine4"},
        {mass: 0.001, x: 140, y: 0, velX: 0, velY: 53, color: "#c00", soundWave:"sine6"}
    ],

    four_star_ballet: [
        {mass: 120, x: -100, y: 100, velX: -50, velY: -50, color: "#ccc", soundWave:"sine2"},
        {mass: 120, x: 100, y: 100, velX: -50, velY: 50, color: "#cc0", soundWave:"sine4"},
        {mass: 120, x: 100, y: -100, velX: 50, velY: 50, color: "#c00", soundWave:"sine6"},
        {mass: 120, x: -100, y: -100, velX: 50, velY: -50, color: "#0cc", soundWave:"sine8"}
    ],

    double_double: [
        {mass: 60, x: -115, y: -3, velX: 0, velY: -155, color: "#ccc", soundWave:"sine2"},
        {mass: 70, x: 102, y: 0, velX: 1, velY: 150, color: "#cc0", soundWave:"sine4"},
        {mass: 55, x: -77, y: -2, velX: -1, velY: 42, color: "#c00", soundWave:"sine6"},
        {mass: 62, x: 135, y: 0, velX: -1, velY: -52, color: "#0cc", soundWave:"sine8"}
    ],

    sun_planet_comet: [
        {mass: 200, x: 0, y: 0, velX: 0, velY: 0, color: "#ccc", soundWave:"sine2"},
        {mass: 1, x: 150, y: 0, velX: 0, velY: 120, color: "#cc0", soundWave:"sine4"},
        {mass: 0.001, x: -220, y: 130, velX: -15, velY: -28, color: "#c00", soundWave:"sine6"}
    ],

    ellipses: [
        {mass: 250, x: -200, y: 0, velX: 0, velY: 0, color: "#ccc", soundWave:"sine2"},
        {mass: 0.001, x: -115, y: 0, velX: 0, velY: 151, color: "#cc0", soundWave:"sine4"},
        {mass: 0.001, x: 50, y: 0, velX: 0, velY: 60, color: "#c00", soundWave:"sine6"},
        {mass: 0.001, x: 220, y: 0, velX: 0, velY: 37, color: "#0cc", soundWave:"sine8"}
    ],

    //http://suki.ipb.ac.rs/3body
    broucke_henon: [
        {mass: 100, x: -100, y: 0, velX: 0, velY: -93.9325, color: "#ccc", soundWave:"sine2"},
        {mass: 100, x: 50, y: -64.7584, velX: -50.5328, velY: 46.96663, color: "#cc0", soundWave:"sine4"},
        {mass: 100, x: 50, y: 64.7584, velX: 50.5328, velY: 46.96663, color: "c00", soundWave:"sine6"}
    ],
